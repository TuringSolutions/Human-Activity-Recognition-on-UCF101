# -*- coding: utf-8 -*-
"""
Created on Fri Feb 21 16:34:13 2020
...
def ReadFrames(train, frames_dir):
    ...
    for i in tqdm(range(train.shape[0])):
        ...
        img = image.load_img(frames_dir+'/'+train['image'][i], target_size=(224,224,3))
...
def PredictOnBatch(test_videos, y, base_model, model, videos_dir):
    ...
    for i in tqdm(range(test_videos.shape[0])):
        videoFile = FrameExtractor(test_videos, index=i, frames_dir='UCF/temp', videos_dir=videos_dir)
